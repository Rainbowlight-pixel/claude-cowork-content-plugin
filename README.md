...
1. **Create a New Project:** Click the "New Project" button on the home screen.
2. **Add Content:** Upload or paste the text or files you want to work on.
3. **Select AI Tasks:** Choose from tasks like rewriting, summarizing, expanding, or translating.
4. **Run Agents:** Click "Start" to let the AI agents carry out the work in parallel.
5. **View Results:** The output will appear in sections for each task. Edit or export as needed.
6. **Save Your Work:** Use the "Save" button to keep your project files for later.
...
- Contact support via the repository’s "Issues" tab if you need help.
